...
//     }
//
//     let noFilterMatch = document.getElementById('no_filter_match')
//     let loadingContainer = document.getElementById('loading_container')
//
//     let keywordTitle = document.getElementById('keyword_title')
//     let keywordTitleCopy = document.getElementById('keyword_title_copy')
//     let originalTitle = keywordTitle.textContent
//
//     let charListContainer = document.getElementById('char_list_container')
